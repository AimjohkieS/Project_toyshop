...
$(document).ready(function() {
  ...
  <?php do { ?>
    ...
    <tr>
      ...
      <td><a href="admin.php?act=rwd&ID=<?php echo $row_am['admin_id']; ?>" class="btn btn-info btn-xs"> เปลี่ยนรหัสผ่าน </a> </td>
      <td><a href="admin.php?act=edit&ID=<?php echo $row_am['admin_id']; ?>" class="btn btn-warning btn-xs"> แก้ไข </a> </td>
       <td><a href="delete_from_admin_db.php?ID=<?php echo $row_am['admin_id']; ?>" class='btn btn-danger btn-xs'  onclick="return confirm('ยันยันการลบ')">ลบ</a> </td>
    </tr>
